...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.open_scraper_button.setText(_translate("MainWindow", "Open Scraper Window", None))
        self.load_urls_button.setText(_translate("MainWindow", "Load urls", None))
        self.clear_urls_button.setText(_translate("MainWindow", "Clear urls", None))
